...
public final class Car { // final 선언시 클래스를 변경하지마라라고 함 --> 상속하지마라****** 있는 그대로를 써라

	// 접근지정자 그외지정자 데이터타입 변수명
	// 클래스 변수
	// 대부분 자체 초기화를 진행한다.
	// static + final 조합 많이 씀
	...
	public final int MAX_PRICE; // final : 한번데이터 값은 변경이 불가하다. -> 초기화 안할 시 에러가 뜬다.
	// 상수들은 보통 대문자로 사용한다.

	public Car() {
		this.MAX_PRICE = 100; // final 은 값을 초기화하면 상수처럼 변경을 못하게 해라
	}
	...
	public final void info2() { // 메서드를 변경하지마라 -> 상속과 관련
