...
public class Study3_solve {
	public static void main(String[]args) {
		...
		double cheon = (total/1000 *0.1) - man;
		cheon =(int)(cheon * 10);
		System.out.println("천원 : " + (int)cheon+ "장"); //25 -> 
		int beak = (total/100) - (man*100) - (int)(cheon *10);
